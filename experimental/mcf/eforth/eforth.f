...
\ eForth, modified for running on Staapl by Tom Schouten, 2007.
\ Based on EFORTH.SRC from eForth Initial Model (eforth86v1.ZIP)
\ http://www.eforth.com.tw/academy-n/zip/eforth86v1.ZIP
