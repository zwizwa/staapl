/*
 * This is a small modification of the file cdcacm.c of the libopencm3
 * example project.  Original copyright notice below.
 * (C) 2014 Tom Schouten <tom@zwizwa.be>
 */
...
void cdcacm_set_config_with_callbacks(usbd_device *usbd_dev, void *rx_cb, void *tx_cb) {
